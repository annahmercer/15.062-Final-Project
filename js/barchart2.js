...
class BarChart2 {
	...
	wrangleData() {
		...
		vis.countedData = Array.from(dataByTitle, ([key, value]) => ({key, value}))
		vis.finalData = vis.countedData.filter(x => x.key != '') // Remove the nulls
		vis.finalData.sort((a, b) => b.value - a.value)
		vis.filteredData = vis.finalData.slice(0, 10)
